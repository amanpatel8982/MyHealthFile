...
const Register = () => {
  ...
  <div className="bg-white shadow-[0_10px_50px_rgba(84,_76,_255,_0.7)] rounded-xl p-8 w-full max-w-md">
    <h2 className="text-3xl flex items-center justify-center font-serif font-semibold text-gray-800 mb-2">Register</h2>

    <form>
      <div className="mb-4">
        <label className="block font-serif text-sm text-gray-700 mb-1" htmlFor="fullname">Full Name:</label>
        <input
          type="text"
          id="fullname"
          placeholder="Enter your full name"
          className="w-full px-4 py-2 font-serif border-2 border-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>

      <div className="mb-4">
        <label className="block font-serif text-sm text-gray-700 mb-1" htmlFor="fullname">Mobile Number:</label>
        <input
          type="tel"
          id="fullname"
          placeholder="Enter your full name"
          className="w-full px-4 py-2 border-2 font-serif border-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>

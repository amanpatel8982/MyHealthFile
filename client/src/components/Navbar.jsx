  ...
  <>
    <div className=" bg-transparent flex h-25 ms-7">
      ...
      <h2 onClick={()=>navigate('/')} className='text-4xl font-bold mt-8 ms-10 font-serif cursor-pointer text-indigo-900 '>MyHealthFile</h2>
       ...
       <button onClick={()=>navigate('/register')} className=' bg-indigo-600 text-white px-6 py-2 font-serif cursor-pointer rounded-full font-light ms-70 hidden md:block  mt-3 hover:scale-110 transition duration-300 ease-in-out shadow-md hover:shadow-lg'>Create Account</button>
       </div>   
     </div>
